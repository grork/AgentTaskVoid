...
/// clock (accrual/demotion) is <c>Atv.Watchdog.ReadyDecayPassTests</c>'s job;
...
public sealed class ReadyDecayClockTests
{
    ...
    public void Broken_LeavingReady_ClearsTheClock()
    {
        ...
        h.Engine.Broken("h1", "T", "S", Icon, Link, Atv.Semantics.BrokenReasonToken.Timeout, null, Now.AddMinutes(2));
    ...
    public void Activity_LeavingReady_ClearsTheClock()
    {
        ...
        h.Engine.Activity("h1", "T", "S", Icon, Link, Atv.Semantics.ActivityKind.Read, "x", agentId: null, name: null, Now.AddMinutes(2));
