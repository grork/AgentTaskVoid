...
Different Names produce different PFNs, which makes the four-pool isolation (release / dev-interactive / reltest / per-worktree test) structural, independent of the still-static Publisher (`CN=AppTaskInfoCli`, pending DIST-2's real cert).
